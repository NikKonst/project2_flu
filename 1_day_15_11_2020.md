...
`cat VarScan_results_alignment_1.vcf | awk 'FNR==1 {print 'reference_base,position,alternative_base,frequency'} NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}' OFS=, > Lab\ notebooks/raw_data/VarScan_results_alignment_1.csv`

`cat VarScan_results_alignment_2.vcf | awk 'FNR==1 {print 'reference_base,position,alternative_base,frequency'} NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}' OFS=, > Lab\ notebooks/raw_data/VarScan_results_alignment_2.csv`

`cat VarScan_results_alignment_3.vcf | awk 'FNR==1 {print 'reference_base,position,alternative_base,frequency'} NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}' OFS=, > Lab\ notebooks/raw_data/VarScan_results_alignment_3.csv`

Results are available by [link](https://docs.google.com/spreadsheets/d/1kitbMT2ZwlZQTmSUmqQsweBDNcl5x0R_dCFn1nGgZN8/edit?usp=sharing).

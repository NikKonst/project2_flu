...
And now create lists containing SNPs the reference base, position, alternative base, and frequency

`cat VarScan_results_alignment_1.vcf | awk 'NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}'`

`cat VarScan_results_alignment_2.vcf | awk 'NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}'`

`cat VarScan_results_alignment_3.vcf | awk 'NR>24 {split($10,a,":"); print $1, $2, $4, $5, a[7]}'`
